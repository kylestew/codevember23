...
export function colorCombinations() {
    ...
    for (const color of data) {
        const { hex, combinations } = color
        for (let combination of combinations) {
            if (combos[combination]) {
                combos[combination].push(hex)
            } else {
                combos[combination] = [hex]
            }
        }
    }
...
const data = [
    ...
    },
    {
        ...
        combinations: [36, 74, 147, 163, 173, 202, 223, 230, 263, 272, 285, 293, 300, 305, 317, 346],
        swatch: 2,
        cmyk: [29, 0, 24, 0],
    ...
    },
    {
        name: 'Black',
        combinations: [
            46, 52, 62, 69, 112, 117, 144, 190, 207, 216, 221, 242, 255, 256, 269, 276, 288, 298, 313, 323, 337, 340,
            344,
        ],
        swatch: 5,
        cmyk: [20, 10, 15, 100],
